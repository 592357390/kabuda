package kabuda.kabuda.com.kabuda.utils;
...
import kabuda.kabuda.com.kabuda.App;
...
public class SPUtil {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(App.app, PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(App.app, PreferenceName, key);
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = App.app.getSharedPreferences(PreferenceName,
